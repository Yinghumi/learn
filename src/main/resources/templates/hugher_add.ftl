    ...
    <div class="row">
      <div class="col-md-4">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation" class="active"><a href="/hugher/add">新增</a></li>
      ...
      <div class="col-md-8">      
        <form action="/hugher/do_add">
            ...
            <div class="form-group">
                <label for="date">上映时间</label>
                <input type="date" class="form-control" id="date" name="date" placeholder="请输入上映时间">
            </div>
